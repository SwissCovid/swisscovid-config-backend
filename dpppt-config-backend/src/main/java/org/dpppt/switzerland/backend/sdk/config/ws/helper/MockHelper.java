...
public class MockHelper {
    ...
    public static ConfigResponse mockConfigResponseWithInfoBox(
            boolean dismissible, Messages messages) {
        ...
        infoBoxde.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz DE");
        ...
        infoBoxfr.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz FR");
        ...
        infoBoxit.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz IT");
        ...
        infoBoxen.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz EN");
        ...
        infoBoxpt.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz PT");
        ...
        infoBoxes.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz ES");
        ...
        infoBoxsq.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz SQ");
        ...
        infoBoxbs.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz BS");
        ...
        infoBoxhr.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz HR");
        ...
        infoBoxrm.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz RM");
        ...
        infoBoxsr.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz SR");
        ...
        infoBoxtr.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz TR");
        ...
        infoBoxti.setMsg(
                "Hier steht ein Text. Das kann ein Hinweis sein. Je länger umso mehr Platz TI");
